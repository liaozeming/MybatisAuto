package com.lzm.mybatisbiz.CodeGeneratorTest;
...
/*
    ...
    private static String parentPackage = "com.lzm.#module_name#";//父包 生成定义文件的文件名
    private static String defaultOutPutPath = "/#module_name#/#module_name#-biz//src/main/java/";//默认模板文件的输出目录


    //     projectPath + otherModule + targetPath  自定义生成的文件
    private static String otherModule = "/nd-common/nd-model/";//需要分模块输出的模块名
    private static String targetPath = "/src/main/java/#module_name#";//data模块模板文件的输出目录
    private static String dbName = "#module_name#";
    private static String url = "jdbc:mysql://localhost:3306/#module_name#?tinyInt1isBit=false&useUnicode=true&useSSL=false&characterEncoding=utf8";
...
//        {"activity","content","creator","interaction","live","member","operate","third","pay",};
        String[] arr = {"user"};//activity,content,creator
